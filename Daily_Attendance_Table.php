...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css" />
        ...
        <script>var currentHour = new Date().getHours();</script>
</head>
<body class = "body bg-white dark:bg-[#0F172A]">
    ...
    <div class = "content ml-12 transform ease-in-out duration-500 pt-20 px-2 md:px-5 pb-4 ">
        <div class="flex flex-row flex-wrap">
            <div class="overflow-hidden flex items-center mt-2">
                <div class="relative text-gray-600">
                    <input type="search" name="search" placeholder="Search" class="bg-white-400 h-10 px-5 pr-10 rounded-full text-sm focus:outline-none" />
        ...
        <div class="container mx-auto px-4 sm:px-8">
            <div class="py-8">
                <div class="flex items-center">
                    <h2 class="text-2xl dark:text-white font-semibold leading-tight">Attendance</h2>
                    <input type="date" id="Selected_Date" onchange="Attendance_Table(2,'Attendance_Table')" class="sm:w-half lg:w-half md:w-half ml-5 px-4 py-2 border rounded-lg text-gray-700 focus:ring-blue-500">
                </div>
                <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                    ...
                    <div class="flex flex-row flex-wrap mt-4 justify-center items-start">
                        <button onclick="Insert_Attendance(event)" id="Save_Button" class="w-auto bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mr-2" hidden>Save</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>Attendance_Table(2,"Attendance_Table");</script>
<script>Get_Module_Permission(2,"Attendance_Table");</script>
</html>
